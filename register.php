...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO admin (name, sex, contact, username, password,photo) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        $stmt->bind_param("ssssss", $name, $sex, $contact, $username, $hashedPwd,$photo_path);
